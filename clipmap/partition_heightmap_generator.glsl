...
layout(set = 0, binding = 0, std430) restrict buffer PartitionVertexDataBuffer {
	float data[];
}
...
void main() {
	...
	partition_data_buffer.data[gl_GlobalInvocationID.x] *= 2.0;
}

// OpenSimplex2 code just copied from source code
